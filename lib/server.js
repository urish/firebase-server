...
var FSp = FirebaseServer.prototype = {
	handleConnection: function (ws) {
		...
		var tryWrite = authHandler.tryWrite.bind(authHandler);
		var tryRead = authHandler.tryRead.bind(authHandler);
		var handleAuth = authHandler.handleAuth.bind(authHandler);
